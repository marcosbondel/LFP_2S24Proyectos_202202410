...
*/
//#$inicio de contlogin contlogin.setAncho(190); contlogin.setAlto(150);
...
//#$fin de contFondo
//#$inicio de cmdIngresar cmdIngresar.setTexto("Ingresar"); contlogin.add(cmdIngresar);
//#$fin de cmdIngresar
//#$inicio de pswClave pswClave.setTexto("");
//#$fin de pswClave
//#$inicio de etiqueta passw
passw.setAncho(53); passw.setAlto(13 ); passw.setColorLetra(128,128,128); passw.setTexto("Password");
fin de Nombre
//#$inicio de JTextField0 JTextField0.setTexto("");
//#$fin de JTextField0
//#$inicio de contlogo2 contlogo2.setAncho(150); contlogo2.setAlto( 50);
contlogo2.setColorFondo(0,128,128);
//#$fin de contlogo2
//#$inicio de ContLogo1
ContLogo1.setAncho(50); ContLogo1.setAlto( 50);
ContLogo1.setColorFondo(64,64,64);
//#$fin de ContLogo1
//#$inicio de ContBody
ContBody.setAncho(800); ContBody.setAlto(300);
...
this.add(contFondo);
contlogin.setPosicion(586,110); ContBody.add(contlogin);
passw.setPosicion(11,54); contlogin.add(passw); cmdIngresar.setPosicion(40,100);
pswClave.setPosicion(67,48); contlogin.add(pswClave);
